    ...
    renderCell: (params) => {
      return (
        <div className="action">
          ...
          {!props.disableViewAction && (
            <div className="delete" onClick={(): void => handleView(params.row.id)}>
              <img src={imgView} alt="Ver" title="Ver" />
            </div>
          )}
      ...
      >
        <DataGrid
          ...
          slots={{
            ...
            footer: props.disableFooterTotalBar ? GridFooter : CustomFooterTotalComponent
          }}
          slotProps={{
            toolbar: {
              showQuickFilter: true,
              quickFilterProps: { debounceMs: 500 },
              csvOptions: { delimiter: ';', fileName: 'dataBase', utf8WithBom: true }
            },
