...
export class ClientModel {
  static async getAll () {
    ...
    const rs = await pool
      .request()
      .query(
        'SELECT cliente_id as id, nombre, tipo_documento, identificacion, direccion, telefono, correo FROM clientes',
      )
  ...
  static async getById ({ id }) {
    ...
    const rs = await pool
      ...
      .input('id', id)
      .query(
        'SELECT cliente_id as id, nombre, tipo_documento, identificacion, direccion, telefono, correo FROM clientes WHERE cliente_id = @id ',
      )
  ...
  static async create ({ input }) {
    const { name, address, phone, documentType, identification, email } = input
  ...
  static async update ({ id, input }) {
    ...
    const rs = await pool
      ...
      .input('email', updateClient.email).query(`UPDATE clientes
